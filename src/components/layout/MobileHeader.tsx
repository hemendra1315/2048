...
export const MobileHeader: React.FC<MobileHeaderProps> = ({ title, onAdminToggle }) => {
  ...
  return (
    <header className="sticky top-0 z-30 lg:hidden bg-vault-950/95 backdrop-blur border-b border-vault-800 px-4 pt-[calc(1rem+env(safe-area-inset-top))] pb-3 flex items-center justify-between gap-3">
